...
void haptics_thread::ComputeVRDesiredDevicePos()
{
    ...
    thumbImpulse = deviceRotation1*rotation1*indexImpulse;
    ...
    chai3d::cVector3d desiredPosMovement0 = forceToPosMult*(filteredDeviceForce0+indexImpulse); //this is only for lateral if we override normal later
    chai3d::cVector3d desiredPosMovement1 = forceToPosMultThumb*(filteredDeviceForce1+thumbImpulse); //this is only for lateral if we override normal later
